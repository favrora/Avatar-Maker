  ...
  <div @click="showShortHairDreads2()">
    <svg viewBox="0 0 270 270">
     <g id="h_shorthairdreads2">
      <path fill="#000000" fill-opacity="0.2" d="M140 69l0 0c-29,0 -55,18 -65,45 5,-7 19,-12 26,-12 6,0 17,0 25,0 5,0 10,0 14,0 5,0 9,0 13,0 9,0 18,-1 26,0 6,1 19,4 26,12 -10,-27 -36,-45 -65,-45z"/>
  ...
  <div @click="showShortHairCurly()">
    <svg viewBox="0 0 200 200">
     <g id="h_shorthaircurly">
      <path fill="#000000" fill-opacity="0.2" d="M169 136l0 -8c0,-38 -31,-69 -69,-69l0 0c-38,0 -69,31 -69,69l0 8c4,-20 4,-32 24,-53 6,1 12,2 19,2 4,1 9,1 14,1 11,-1 26,-3 36,-9 2,1 5,2 7,3 2,1 4,2 5,3 3,7 10,11 16,15 3,15 13,21 17,38z"/>
  ...
  <div @click="showShortHairFlat()">
    <svg viewBox="0 0 200 200">
     <g id="h_shorthairflat">
      <path fill="#000000" fill-opacity="0.2" d="M166 137l3 -9c10,-36 -31,-69 -69,-69l0 0c-38,0 -75,32 -69,69l1 9c2,-14 2,-16 9,-32 4,-6 8,-11 13,-16 4,-4 7,-8 9,-13 24,3 47,2 70,0 2,3 5,6 8,9 2,3 5,5 8,7 4,3 6,7 8,12 4,10 6,23 9,33z"/>
  ...
  <div @click="showShortHairRound()">
    <svg viewBox="0 0 200 200">
     <g id="h_shorthairround">
      <path fill="#000000" fill-opacity="0.2" d="M168 136l0 -7c0,-38 -31,-69 -68,-69l0 0c-38,0 -69,31 -69,69l0 7c0,-19 12,-41 34,-48 0,1 0,2 0,3l0 3 3 0c19,1 36,-4 52,-13 3,3 8,6 12,8 6,4 13,7 19,11 3,2 6,4 8,7 7,10 6,12 9,29z"/>
  ...
  <div @click="showShortHairWaved()">
    <svg viewBox="0 0 200 200">
     <g id="h_shorthairwaved">
      <path fill="#000000" fill-opacity="0.2" d="M168 136l1 -8c4,-37 -31,-69 -69,-69l0 0c-38,0 -76,32 -69,69l2 8c2,-11 2,-16 9,-33 3,-6 7,-10 12,-15 3,-3 5,-5 7,-9 24,18 52,15 78,2 1,3 2,5 5,7 1,2 4,3 6,5 2,2 4,4 5,6 9,18 9,22 13,37z"/>
