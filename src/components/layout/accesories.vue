<template>
  <svg id="accesories" width="360px" height="360px" viewBox="0 0 360 360" style="z-index: 100">
    <g id="a_earphones">
...
export default {
  ...
  methods: {
    picker: function() {
      ...
      var chosenNameAccesories = this.list[chosenAccesories];

      document.querySelector(chosenNameAccesories).classList.add('show');
    }
  },
